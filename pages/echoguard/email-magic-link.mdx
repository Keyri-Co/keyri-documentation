...
EchoGuard provides a simple, and secure email magic link solution that allows
you to authenticate users by proving that they own their email address. And
email containing a special link is sent to an address they provide. Once they
click the link, they are directed to a page that verifies they clicked a link
only they could have received.
