...
For analysis and decryption of the object created by the client, you will need to hit our REST API Server with a payload like described below.
...
// Nothing to import.
  ...
  const sendBody = {
    ...
    "metadata": {},
    // We need you to give us the IP Address of client
    ipAddress,
