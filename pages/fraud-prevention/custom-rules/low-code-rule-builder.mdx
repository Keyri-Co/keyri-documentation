...
any complexity to suit your application by harnessing all of the data that Keyri
collects and calculates. Rulesets are written as JSON objects using the MongoDB
query syntax. Please reference [this page](/fraud-prevention/custom-rules) for a
full list of available conditions that you can evaluate in your rules and our
[cookbook](/fraud-prevention/custom-rules/custom-rules-cookbook) for examples of
useful custom rules.
...
current transaction amount are Greater Than or Equal to; evaluate to true
