...
| Improbable Travel | The account has enacted an event from an IP address that is too far away from a previous event IP address in the allotted time period (e.g., a user logging in from San Francisco and then logging in from New York one hour later). |
| New Country       | The account has not previously seen an event with an IP address in a given country.                                                                                                                                                  |
