---
description: Prevent phishing attacks, including endpoint malware and DNS spoofing, with location intelligence, known attacker databases, and anonymous proxy detection.
---
