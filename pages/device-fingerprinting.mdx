---
description: Stop fraud today with Keyri's mobile and browser fingerprinting, starting with fraudulent account opening, account takeovers, bot prevention, and promo abuse.
---

# Device Fingerprinting

Keyri provides powerful tools for fingerprinting your users' devices, in both your mobile app and web app. The Keyri [mobile SDKs](/mobile-sdks) provide useful methods for permanently associating users with their devices, and our [Javascript fingerprinting agent](https://www.npmjs.com/package/keyri-fingerprint) can be used to fingerprint your users' browsers, whether they're on incognito/private browsing or not.
