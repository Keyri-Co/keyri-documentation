...
[sign up for a free account](https://app.keyri.com/sign-up).

Then proceed to install the [Keyri QR Widget](./qr-authentication/qr-web-widget)
on your web frontend and the [Keyri SDK](../mobile-sdks/installation) in your
mobile app.
