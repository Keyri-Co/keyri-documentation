...
```kotlin copy enableInterpolation
dependencies {
    // ...
...
dependencies {
    // ...
    implementation("com.keyri:keyrisdk:${AndroidSDKVersion}")
    implementation("com.keyri:keyrisdk-java:${AndroidSDKVersion}")
}
```
...
dependencies {
    // ...
    implementation("com.keyri:keyrisdk:${AndroidSDKVersion}")
    implementation("com.keyri:scanner:${AndroidSDKVersion}")
}
```
...
dependencies {
    // ...
    implementation("com.keyri:keyrisdk:${AndroidSDKVersion}")
    implementation("com.keyri:compose:${AndroidSDKVersion}")
}
```
