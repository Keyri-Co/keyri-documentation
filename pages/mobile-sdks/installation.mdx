...
Initialize the Keyri object with keys from the dashboard. If you're using fraud
...
<Tabs items={['iOS', 'Kotlin', 'Java', 'React Native', 'Flutter', 'Cordova']}>
    ...
    <Tab>
        ```kotlin copy
        // Import the SDK at the top of the file
    ...
    <Tab>
        ```javascript copy
        Keyri.initialize({appKey: appKey, publicApiKey: publicApiKey,serviceEncryptionKey: serviceEncryptionKey})
        ```
    </Tab>
    <Tab>
        ```dart copy
