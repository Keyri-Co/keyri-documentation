---
description: AlphaPoint APEX customers can add QR authentication to their webpage to create a secure, easy-to-use, and convenient auth system for their users.
---
