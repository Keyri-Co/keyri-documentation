---
description: How to integrate the Keyri QR login into an AlphaPoint APEX-based Android app
---
...
3. Finally, the function must return values for `APIKey`, `APISecret`, and `UserId`. These three items will subsequently be passed into the Keyri `initializeQrSession()` method. Please see the [Android App Integration](/mobile-sdks/android) page for details on how this function is invoked
