...
3. Finally, the function must return values for `APIKey`, `APISecret`, and `UserId`. These three items will subsequently be passed into the Keyri `initiateQrSession()` method. Please see the [iOS App Integration](/mobile-sdks/ios) page for details on how this function is invoked
