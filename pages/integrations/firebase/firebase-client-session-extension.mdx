...
try {
    ...
    final emailVerified = credential.emailVerified
    final isAnon = credential.isAnonymous
    final providerData = credential.providerData

    await keyri
    .easyKeyriAuth("[APPKey]",
        '{"refreshToken":"$refreshToken",
        "uid": "$uid",
        "emailVerified": "emailVerified"}', emailAddress)
